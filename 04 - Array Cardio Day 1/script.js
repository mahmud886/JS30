...
const totalYearAllTogether = inventors.reduce((total, inventor) => {
    return total + (inventor.passed - inventor.year);
}, 0);
// console.log(totalYearAllTogether);
...
const sortAlphaLastName = people.sort((firstName, lastName) => {
...
const transportation = data.reduce((acc, value) => {
